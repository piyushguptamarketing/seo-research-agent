...
# ── API key setup ─────────────────────────────────────────────────────────────
with st.expander("⚙️ API Keys (required — click to add)", expanded=False):
...
with col_a:
    domain = st.text_input("Your domain", placeholder="e.g. yourdomain.com")
    brand  = st.text_input("Brand name", placeholder="e.g. Your Brand")
with col_b:
    keywords_raw = st.text_area(
        "Target keywords (one per line)",
        placeholder="e.g. best project management software\ne.g. top CRM for startups\ne.g. email marketing tool",
        height=130
    )
...
with col_c:
    llm_queries_raw = st.text_area(
        ...
        placeholder="e.g. what is the best CRM tool\ne.g. top marketing software for startups",
        height=100
    )
with col_d:
